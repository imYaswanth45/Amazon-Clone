    ...
    return (
        <header>
            <nav>
                <div className="left">
                    ...
                    <div className="navlogo">
                        <NavLink to="/">   <img src="https://www.careerindia.com/img/2014/03/24-nitraipur.jpg" width="1000" height="65"  alt="" /></NavLink>
                    </div>
            ...
            <div className="right">
                ...
                <div className="nav_btn">
                   {account ? <NavLink to="/buy">Buy</NavLink>: " " }
                </div>
                <div className="nav_btn">
                {account ? <NavLink to="/sell">sell</NavLink>: " " }
                </div>
